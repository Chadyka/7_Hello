...
public class imageToAscii {
    ...
    public static void main(String[] args) {
        ...
        try {
            image = ImageIO.read(new File("./deer.jpg"));
            if (image == null) throw new IllegalArgumentException("Not a valid image.");
            final String ascii = new imageToAscii().convert(image);
